...
TPROXY_MARK=0x00000001
ADGUARD_MARK=0x00000002
...
start_service() {
    ...
    ip -6 rule add fwmark $TPROXY_MARK table 106
...
stop_service() {
    ...
    ip rule del fwmark $TPROXY_MARK table 100
    ip route del local 0.0.0.0/0 dev lo table 100
    ip -6 rule del fwmark $TPROXY_MARK table 106
